...
1. Lire le cahier des charges pour comprendre le besoin du projet.
2. Consulter l’analyse préliminaire pour voir la solution proposée.
3. Vérifier la sécurité et l’infrastructure dans les fichiers dédiés.
4. Vérifier la mise en place d’un environnement de test séparé.

Ces documents sont structurés pour présenter le projet de manière professionnelle, sans référence directe aux demandes de rendu ou aux numéros de session.
